                  ...
                  <div class="row pt-4 pb-4 px-2">
                    <div class="col-md-12">
                      <div class="product-add-btn">
                        <a  href="addCategory.php" class="add-user">Add Product Category</a>
                       </div>
                       ...
                       <table class="table"">
                        ...
                        foreach ($products as $i => $product): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="updateCategory.php?id=<?php echo $product['id'] ?>" type="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                   <form style="display: inline-block" method="post" action="deleteCategory.php" >
