...
$statement = $pdo->prepare('SELECT * FROM sub_category ORDER BY id DESC');
$statement->execute();
                  ...
                  <div class="row pt-4 pb-4 px-2">
                    <div class="col-md-12">
                      <div class="product-add-btn">
                        <a  href="addSubCategory.php" class="add-user">Add Product Sub Category</a>
                       </div>
                       ...
                       <table class="table" id="example">
                        ...
                        foreach ($products as $i => $product): ?>
                            <tr>
                                ...
                                <td id="example"><?php echo $product ['sub_category_name'] ?></td>
                                <td><?php
                                ...
                                <td>
                                    <a href="updateSubCategory.php?id=<?php echo $product['id'] ?>" type="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                   <form style="display: inline-block" method="post"                      action="deleteSubCategory.php" >
