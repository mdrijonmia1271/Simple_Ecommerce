...
$statement = $pdo->prepare('SELECT * FROM colors ORDER BY id DESC');
$statement->execute();
      ...
      <div class="main-content-inner pt-4">
        <div class="row pb-3 pt-3">
          <div class="col-md-3 col-sm-3">
            <h4 style="margin-bottom: 0;">Products Colors</h4>
          </div>
                  ...
                  <div class="row pt-4 pb-4 px-2">
                    <div class="col-md-12">
                      <div class="product-add-btn">
                        <a  href="addColor.php" class="add-user">Add Product Color</a>
                       </div>
                       ...
                       <table class="table" id="example">
                        ...
                        foreach ($products as $i => $product): ?>
                            <tr>
                                ...
                                <td id="example"><?php echo $product ['color_name'] ?></td>
                                <td><?php echo $product ['create_date'] ?></td>
                                <td>
                                    <a href="updateColor.php?id=<?php echo $product['id'] ?>" type="button" class="btn btn-sm btn-outline-primary">Edit</a>
                                   <form style="display: inline-block" method="post" action="deleteColor.php" >
