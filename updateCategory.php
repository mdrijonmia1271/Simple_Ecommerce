...
if(!empty($category_name)){
    $statement = $pdo->prepare("UPDATE category  SET category_name = :category_name, category_description = :category_description, status = :status
    WHERE id = :id");
        ...
        <div class="row" >
          <div class="col-md-12  " >
           ...
           <form action="" method="post" enctype="multipart/form-data">
              <h5> Update Products Category</h5>
