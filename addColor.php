...
if(!empty($color_name)){
  $connect->query("INSERT INTO colors (color_name, color_description, create_date, status) VAlUE('$color_name', '$color_description', '$date', '$status')");
        ...
        <div class="row" >
          <div class="col-md-12  " >
            ...
            <table style="width:100%" class="current-data-table" > 
              <tr>
                <th>Color Name:</th>
                <td><input type="text" name="color_name" placeholder="Color Name">
                <br>
              ...
              <tr>
                ...
                <td>
                  <textarea cols="50" name="color_description" placeholder="Description"></textarea>
                </td>
              </tr>
              <tr>
                <th>Status:</th>
